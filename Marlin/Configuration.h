...
#define STRING_CONFIG_H_AUTHOR "jkmathew" // Who made the changes.
#define CUSTOM_VERSION_FILE _Version.h // Path from the root directory (no quotes)
...
#define CUSTOM_MACHINE_NAME "jkmathew p1.1"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -39.2, -4.5, -3.3 }
